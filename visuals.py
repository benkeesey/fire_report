...
class Visualization(object):
    ...
    def color_schemes(self):
        ...
        if self.color_scheme in color_schemes_available:
            ...
            warnings.warn(
                "Warning! No valid color scheme picked, default selected.\nPlease pick from the following choices:\noffice_pastel\nmountain_range\nxerox\nstickies\nmiami_sunrise"
            )
            color_tuple = color_schemes_available[self.color_scheme]
    ...
    def spending_fire_plot(self, df, file_name):
        ...
        )  # No decimal places with dollar sign
        ...
        ax.legend(
            labelcolor=[self.color_1],
            loc="upper left",
            edgecolor=self.color_font,
    ...
    def Backtesting_Plot_Growth_Comparison(
        self, account1, account1_name, account2, account2_name, cash_account
    ):
        """
        ...
        ax.legend(
            labelcolor=[self.color_1, self.color_2, self.color_3],
            loc="upper left",
            edgecolor=self.color_font,
            facecolor=self.color_background,
        )
        ...
        plt.annotate(
            currency_string,
            (self.time_window + 0.5, num),
            color=self.color_3,
            verticalalignment="center",
        )
        # Save Matplotlib figure as png file in Assets folder
        plt.savefig(
            "Assets/Backtesting_Plot_Growth_Comparison.png",
            dpi=80,
            facecolor=self.color_background,
            bbox_inches="tight",
            pad_inches=0,
    ...
    def Backtesting_Plot_Spending_Statistics(self, df):
        ...
        return (
            success_percentage,
            final_first_quartile,
            final_median,
            final_third_quartile,
        )
    ...
    def Dashboard(self, liquid_df, net_df, save_filename=None):
        ...
        icon1 = pn.pane.PNG(
            "Assets/fire.png", height=60, sizing_mode="fixed", align="center"
        )

        icon2 = pn.pane.PNG(
            "Assets/stock-market.png", height=60, sizing_mode="fixed", align="center"
        )
        ...
        (
            ...
            final_median,
            final_third_quartile,
        ) = self.Backtesting_Plot_Spending_Statistics(liquid_df)
        ...
        liquid_stat1_val = pn.pane.Markdown(
            f"# {success_percentage}%",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
            margin=(10, 5, 10, 0),
        ...
        liquid_stat2 = pn.pane.Markdown(
            f"#### Ending 25% Quantile Portfolio Balance:",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
            margin=(10, 0, 10, 15),
        ...
        liquid_stat2_val = pn.pane.Markdown(
            f"#{final_first_quartile_str}",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
            margin=(10, 15, 10, 0),
        ...
        liquid_stat3 = pn.pane.Markdown(
            f"#### Ending 75% Quantile Portfolio Balance:",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
            margin=(10, 0, 10, 15),
        ...
        liquid_stat3_val = pn.pane.Markdown(
            f"#{final_third_quartile_str}",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
            margin=(10, 15, 10, 0),
        ...
        (
            ...
            final_median,
            final_third_quartile,
        ) = self.Backtesting_Plot_Spending_Statistics(net_df)
        # Create Markdown Text fields of the statistics to show in Dashboard
        # Change the values to show in the correct currency string format
        final_first_quartile_str = "${:,.0f}".format(self.final_first_quartile)
        final_median_str = "${:,.0f}".format(self.final_median)
        ...
        net_stat1_val = pn.pane.Markdown(
            f"# {success_percentage}%",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
        ...
        net_stat2_val = pn.pane.Markdown(
            f"#{final_first_quartile_str}",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
        ...
        net_stat3_val = pn.pane.Markdown(
            f"#{final_third_quartile_str}",
            style={"color": self.color_font},
            height=70,
            sizing_mode="stretch_width",
        ...
        growth_plot_title = pn.pane.Markdown(
            md.growth_plot_title_md,
            style={"color": self.color_font},
            sizing_mode="fixed",
            margin=(10, 5, 5, 15),
            width=1250,
        ...
        growth_plot_account_info = pn.pane.Markdown(
            md.growth_plot_account_info_md,
            style={"color": self.color_font},
            width=1250,
            sizing_mode="scale_both",
            margin=(10, 5, 10, 15),
        ...
        growth_plot_header = pn.Column(
            growth_plot_title,
            growth_plot_account_info,
            background=self.color_background,
            sizing_mode="fixed",
            width=1250,
            height=300,
        ...
        growth_comparison_plot = pn.pane.PNG(
            "Assets/Backtesting_Plot_Growth_Comparison.png",
            sizing_mode="scale_both",
            align="center",
        )
        growth_comparison_plot_row = pn.Row(
            growth_comparison_plot, background=self.color_background, width=1250
        )

        # FIRE Spending Plot Header Creation
        spending_plot_title = pn.pane.Markdown(
            md.spending_plot_title_md,
            style={"color": self.color_font},
            width=500,
            height=50,
            sizing_mode="stretch_width",
        ...
        spending_plot_header = pn.Column(
            spending_plot_title,
            spending_plot_info,
            background=self.color_background,
        ...
        liquid_plot = pn.pane.PNG(
            liquid_plot_filename, sizing_mode="scale_both", align="center"
        )
        liquid_plot_row = pn.Row(
            liquid_plot, background=self.color_background, width=1250
        )

        net_asset_plot = pn.pane.PNG(
            f"Assets/{self.name}'s Net Backtesting Plot.png",
            sizing_mode="scale_both",
            align="center",
        )
        net_asset_plot_row = pn.Row(
            net_asset_plot, background=self.color_background, width=1250
        )
        ...
        dashboard = pn.Column(
            ...
            intro_info_row,
            growth_plot_header,
            growth_comparison_plot_row,
            spending_plot_header,
            liquid_stat_row,
            liquid_plot_row,
            net_stat_row,
            net_asset_plot_row,
        ...
        if save_filename == None:
            pn.panel(dashboard).save(
                "Assets/HSA_and_Portfolio_Success_Analysis.html", resources=INLINE
            )
        else:
